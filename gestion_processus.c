...
void afficherProcessus(Processus p[], int n){
    printf("\n================ LISTE DES PROCESSUS ================\n");
    printf("ID   Arrivee   Burst   Priorite\n");
    printf("-------------------------------------\n");
    for(int i=0;i<n;i++)
...
void menu(){
    printf("\n===== MENU =====\n");
    printf("1. FCFS\n");
    printf("2. SJF Non Preemptif\n");
    printf("3. SRTF\n");
    printf("4. Priorite Non Preemptif\n");
    printf("5. Priorite Preemptive\n");
...
void comparer(Processus base[], int n, int quantum){
    ...
    char noms[6][30]={"FCFS","SJF NP","SRTF","Priorite NP","Priorite P","Round Robin"};
...
int main(){
    int n, choix, quantum;
    printf("=====Implementation des Algorithmes d Ordonnancement CPU=====\n");
    ...
    for(int i=0;i<n;i++){
        ...
        base[i].arrivee=i;
        printf("Entrer la duree d execution %s : ",base[i].id);
        scanf("%d",&base[i].burst);
        printf("Entrer la priorite %s : ",base[i].id);
